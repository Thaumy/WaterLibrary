...
namespace StdLib//StdLib1.11
{
    namespace DataHandler
    {
        ...
        public class MySqlConnectionHandler
        {
            ...
            public virtual bool HConnection_Close()
            {
                try
                {
            ...
            /// </summary>
            /// <returns>成功返回ture，反之或报错返回false</returns>
            public virtual bool HConnection_Dispose()
            {
                try
                {
                    switch (HConnection.State)
            ...
            /// </summary>
            /// <returns>成功返回ture，反之或报错返回false</returns>
            public virtual bool HConnection_null()
            {
                try
                {
                    HConnection = null;
            ...
            /// </summary>
            /// <returns>成功返回ture，反之或报错返回false</returns>
            public virtual bool HConnection_restart()
            {
                try
                {
                    switch (HConnection.State)
            ...
            /// </summary>
            /// <returns>成功返回ture，反之或报错返回false</returns>
            public virtual bool HCommand_Dispose()
            {
                try
                {
                    HCommand.Dispose();
            ...
            /// </summary>
            /// <returns>成功返回ture，反之或报错返回false</returns>
            public virtual bool HCommand_null()
            {
                try
                {
                    HCommand = null;
            ...
            /// <returns>成功返回ture，反之或报错返回false</returns>
            public virtual bool HCommand_set(MySqlConnection MySqlConnection, string sql)
            {
                try
                {
            ...
            /// <param name="sql">被设置的sql语句</param>
            /// <returns>成功返回ture，反之或报错返回false</returns>
            public virtual bool HCommand_set(string sql)
            {
                try
                {
            ...
            public virtual bool start(string dataSource, string port, string userName, string password)
            {
                //组建连接信息并创建连接
            ...
            public virtual bool start(connStr connStr)
            {
                //组建连接信息并创建连接
                HConnection = new MySqlConnection
                    (
            ...
            /// <returns>返回true，错误则返回false</returns>
            public virtual bool start(MySqlConnection MySqlConnection)
            {
            ...
            public virtual DataRow getRow(MySqlConnection MySqlConnection, string sql)
            {
                try
                {
            ...
            /// <returns>返回查询结果</returns>
            public virtual DataRow getRow(MySqlConnection MySqlConnection, MySqlCommand MySqlCommand)
            {
                try
                {
                    if (MySqlConnection.State == ConnectionState.Closed)//判断连接是否被关闭
            ...
            /// <param name="sql">SQL语句</param>
            /// <returns>返回查询结果</returns>
            public virtual DataRow getRow(string sql)
            {
                try
                {
            ...
            /// <returns>返回查询结果</returns>
            /// 
            public virtual DataRow getRow(MySqlCommand MySqlCommand)
            {
                try
                {
                    if (HConnection.State == ConnectionState.Closed)//判断连接是否被关闭
            ...
            public virtual DataRow getRow(DataTable DataTable, string keyName, object keyValue)
            {
            ...
            public virtual MySqlConnection getConnection(string dataSource, string port, string userName, string password)
            {
                try
                {
                    //返回创建的连接
            ...
            /// <param name="connStr">用于参与连接数据库的文本结构</param>
            /// <returns>返回一个MySqlConnection对象，错误则返回null</returns>
            public virtual MySqlConnection getConnection(connStr connStr)
            {
                try
                {
                    //返回创建的连接
            ...
            public virtual DataTable getTable(MySqlConnection MySqlConnection, string sql)
            {
                try
                {
                    //新建数据适配器
            ...
            /// <param name="MySqlCommand">MySqlCommand对象，用于进行查询</param>
            /// <returns>返回一个DataTable对象，错误则返回null</returns>
            public virtual DataTable getTable(MySqlConnection MySqlConnection, MySqlCommand MySqlCommand)
            {
                try
                {
                    //将外来cmd设置为基于MySqlConnection执行
            ...
            /// <param name="MySqlCommand">MySqlCommand对象，用于进行查询</param>
            /// <returns>返回一个DataTable对象，错误则返回null</returns>
            public virtual DataTable getTable(MySqlCommand MySqlCommand)
            {
                try
                {
                    //将外来cmd设置为基于HConnection执行
            ...
            public virtual List<object> getColumn(DataTable DataTable, string columnName)
            {
                try
                {
            ...
            public virtual bool setColumnValue(MySqlConnection MySqlConnection, locateStr locateStr, string whereColumnValue, string targetColumnValue)
            {
                #region SQL字符串处理
            ...
            /// <param name="targetColumnValue">被改列的改值</param>
            /// <returns>操作成功返回true</returns>
            public virtual bool setColumnValue(locateStr locateStr, string whereColumnValue, string targetColumnValue)
            {
                #region SQL字符串处理
                string sql = "UPDATE `" + locateStr.dataBaseName + "`.`" + locateStr.tableName
                           + "` SET `" + locateStr.targetColumnName + "`= '" + targetColumnValue
            ...
            /// <param name="whereColumnValue">定位列的列值</param>
            /// <returns>操作成功返回true</returns>
            public virtual object getColumnValue(MySqlConnection MySqlConnection, locateStr locateStr, string whereColumnValue)
            {
                #region SQL字符串处理
            ...
            /// <param name="whereColumnValue">定位列的列值</param>
            /// <returns>操作成功返回true</returns>
            public virtual object getColumnValue(locateStr locateStr, string whereColumnValue)
            {
                #region SQL字符串处理
                string sql = "select " + locateStr.targetColumnName
                           + " from " + locateStr.dataBaseName + "." + locateStr.tableName
