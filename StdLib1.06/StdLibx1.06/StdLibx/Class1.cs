...
namespace StdLib1_16//StdLib1.06总空间
{
    ...
    namespace StdEct//算法加密空间(Encryption)
    {
        ...
        public static class Class_Hash
        {
            ...
            /// 散列方法
            /// </summary>
            /// <param name="InputStr">被加密的字符串</param>
            /// <returns>通常返回散列加密结果，报错则返回错误信息</returns>
            public static string Main_Hash(string InputStr)
            {
                try
                {
        ...
        public static class Class_MD5
        {
            ...
            public static string Main_MD5(string InputStr)
            {
                try
                {
        ...
        public static class Class_LSS
        {
            ...
            /// <returns>通常返回有序数组，报错则返回null</returns>
        ...
        public sealed class Class_ANSW
        {
            ...
            /// <summary>
            /// ANSW2Dcode加密方法:注意hex至少由4个16进制字符组成
            /// </summary>
            /// <param name="hex">被加密的16进制字符串</param>
            /// <param name="stream">bmp模板流</param>
            /// <returns>通常返回加密后的bmp，报错则返回流错误bmp图像</returns>
            public Bitmap ToANSW(string hex, string stream)
            {
                try
                {
                    #region 初始化
                    ...
                    return outputBP;//返回bmp
                }
                catch
                {
                    return StdLibx.Resource1.StreamError;//出现错误则返回自带的流错误bmp图像
                }
            }
        }//Class_ANSW
        ...
        public sealed class Class_XmlCreater
        {
            ...
            public static bool AddRealNode(XmlInf inf)
            {
                try
                {
                    ...
                    XmlAttribute newAtt = xDoc.CreateAttribute(inf.attName);//创建用于新的子节点的一个属性，名称为Value的值
