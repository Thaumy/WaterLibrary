...
namespace StdLib
{
    namespace FrameHandler//版本控制
    {
        ...
        public sealed class LibInformation : IStdLibFrame
        {
            ...
            private static string _HlinfURL = "https://thaumy.github.io/StdLib1x/xplore/st110_Hlinf.html";

            private int _projectVer = 110;//1.10

            private string _projectMoniker = "st110";

            private string _editionType = "public";

            private string _stepping = "b1";
