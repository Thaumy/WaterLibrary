...
namespace StdLib
{
    namespace FrameHandler//版本控制
    {
        ...
        public sealed class LibInformation : IStdLibFrame
        {
            ...
            private static string _HlinfURL = "https://thaumy.github.io/StdLib1x/xplore/st113_Hlinf.html";

            private int _projectVer = 113;

            private string _projectMoniker = "st113";
